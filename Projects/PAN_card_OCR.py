...
image = cv2.imread('D:/G A L T I/Semester 5/pan_img.jpg')
...
# the temporary file
pytesseract.pytesseract.tesseract_cmd = 'C:/Users/abc/AppData/Local/Programs/Python/Python38/Lib/site-packages/pytesseract/pytesseract.py'
text = pytesseract.image_to_string(Image.open('pan_bw.jpg'), lang = 'eng')
# add +hin after eng within the same argument to extract hindi specific text - change encoding to utf-8 while writing
os.remove('pan_bw.jpg')
# print(text)
